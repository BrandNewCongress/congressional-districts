...
var maxCandidateConfiguration = 0;
...
var setupSliders = function() {
  ...
  document.getElementById('maxCandidate').max = maxLength;
  document.getElementById('maxCandidate').value = maxLength;
  document.getElementById('maxCandidateValue').innerText = maxLength;
};
...
var heatmapDistrictOpacity = function(t) {
  const count = (t.properties.candidates || []).length;
...
var addCandidateData = function(data, candidateData) {
  data.objects.states.geometries.forEach(function(datum) {
    if(datum.properties.state == 'Ocean') return;
    ...
    maxCandidateConfiguration = maxLength;
...
document.addEventListener( "DOMContentLoaded", function(){
  document.getElementById('heatmap').addEventListener('change', function() {
    heatmapActivated = document.getElementById('heatmap').checked;
    recolor();
  });

  document.getElementById('minCandidate').addEventListener('change', function() {
    const value = document.getElementById('minCandidate').value;
    document.getElementById('minCandidateValue').innerText = value;
    minCandidateConfiguration = value;
    recolor();
  });

  document.getElementById('maxCandidate').addEventListener('change', function() {
    const value = document.getElementById('maxCandidate').value;
    document.getElementById('maxCandidateValue').innerText = value;
    maxCandidateConfiguration = value;
    recolor();
  });
}, false);
